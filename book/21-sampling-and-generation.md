...
- Softmax and temperature scaling from [02-probability-and-softmax](02-probability-and-softmax.md).
- Bigram CDF sampling from [05-bigram-language-model](05-bigram-language-model.md).
...
- The trained 24-parameter LM from [18-training-loop](18-training-loop.md).
...
H T=1.0    : 1.6628201468545778
H T=2.0    : 2.0796802571663133
